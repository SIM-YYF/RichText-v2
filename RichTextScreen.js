...
export default class RichTextScreen extends Component {
    ...
    static navigationOptions = ({ navigation }) => ({
        ...
        headerRight:(
            <View>
                <Text style={{color:'#ffffff'}}  onPress={() => navigation.navigate('Preview', { titleHtml: 'titleHtml', contentHtml: 'contentHtml'})}  >  保存 </Text>
            </View>
        ),
        headerLeft:(<View>
            <Text style={{color:'#ffffff'}} onPress={() => alert("取消")}  >  取消 </Text>
        </View>),

...
export default class RichTextEditor extends Component {
  ...
  setEditorAvailableHeightBasedOnKeyboardHeight(keyboardHeight) {
    ...
    const editorAvailableHeight =
      ...
      console.log('----------- keyboardHeight = ', editorAvailableHeight)
      ...
      switch (message.type) {
        ...
        case messages.SELECTED_TEXT_CHANGED: {
          const selectedText = message.data;
            console.log("========== SELECTED_TEXT_CHANGED", selectedText)
      ...
      <View>
        ...
        >
          ...
          >
            ...
            >
              <Text style={[styles.button]}>关 闭</Text>
            </TouchableOpacity>
          </View>
        </Modal>
        ...
        <Modal
          animationType={"fade"}
          transparent={false}
          visible={this.state.showPlayAudioModal}
          onRequestClose={() => this.setState({ showPlayAudioModal: false })}
        >
          <View
            style={{
              flex: 1,
          ...
          >
            <Image
              ...
              source = {require('../img/left_voice_play_icon.gif')}
            />

            <TouchableOpacity
              style={{ marginTop: 60}}
              onPress={this._closePlayAudioModal.bind(this)}
            >
              <Text style={[styles.button]}>关 闭</Text>
            </TouchableOpacity>
          </View>
  ...
  insertAudio(attributes) {
    // console.log("=========== insertAudio attributes =======", attributes);
    this.prepareInsert();
  ...
  setShowKeyboard(isShow){
    this._sendAction(actions.showKeyboard, isShow);
  }

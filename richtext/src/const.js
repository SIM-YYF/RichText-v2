...
export const actions = {
  ...
  insertCoverImage: 'INSERT_COVER_IMAGE',
  insertTable: 'INST_TABLE',
  ...
  setBlockquote: 'SET_BLOCK_QUOTE',
  keyboardHide:'KEY_BOARD_HIDE',

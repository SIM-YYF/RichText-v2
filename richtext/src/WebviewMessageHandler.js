    ...
    WebViewBridge.onMessage = function (message) {
      ...
      switch(action.type) {
        ...
        case '${actions.insertImage}':
          ...
          break;
        case '${actions.insertCoverImage}':
          zss_editor.insertCoverImage(action.data);
          break;
        case '${actions.insertTable}':
          zss_editor.insertTable(action.data.rows, action.data.cols);
          break;
        case '${actions.insertEmbed}':
          zss_editor.insertEmbed(action.data);
          break;
          case '${actions.insertAudio}':
          zss_editor.insertAudio(action.data);
          break;
        ...
        case '${actions.setBlockquote}':
          ...
          break;
        case '${actions.keyboardHide}':
          zss_editor.keyboardHide();
          break;
        case '${actions.showKeyboard}':
          zss_editor.showKeyboard(action.data);
          break;
      }
    };
  }
